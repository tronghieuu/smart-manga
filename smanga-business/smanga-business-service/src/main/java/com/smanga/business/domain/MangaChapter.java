...
public class MangaChapter extends BaseEntity
{
    ...
    public void setChapterImageIds(Long chapterImageIds) 
    {
        this.chapterImageIds = chapterImageIds;
    }

    public Long getChapterImageIds() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("chapterIndex", getChapterIndex())
            .append("chapterLang", getChapterLang())
            .append("chapterImages", getChapterImages())
            .append("chapterImageIds", getChapterImageIds())
            .append("mangaId", getMangaId())
            .append("viewCounter", getViewCounter())
