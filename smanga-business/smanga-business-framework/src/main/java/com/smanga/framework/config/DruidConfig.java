...
import com.smanga.framework.config.properties.DruidProperties;
import com.smanga.framework.datasource.DynamicDataSource;

/**
 * Druid configures multiple data sources
 * 
 * @author Trong Hieu
 */
@Configuration
