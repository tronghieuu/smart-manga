...
import com.smanga.common.utils.uuid.IdUtils;
...
public class FileUploadUtils {
	 ...
	 */
	private static String defaultBaseDir = SmartMangaConfig.getProfile();
	 ...
	 * @throws IOException                          such as when there is an error
	...
	private static final String getPathFileName(String uploadDir, String fileName) throws IOException {
		int dirLastIndex = SmartMangaConfig.getProfile().length() + 1;
